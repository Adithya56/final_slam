...
public class OrderDAOImp implements OrderDAO {
	...
	private String ins = "INSERT INTO slam_orders (ordr_cust_id, ordr_billno, ordr_odate, ordr_total, ordr_gst, ordr_payreference, ordr_paymode, ordr_paystatus, ordr_saddress, order_shipment_status,ordr_shipment_date,ordr_spincode) VALUES (?, ?, CURRENT_TIMESTAMP,?, ?, ?, ?, ?, ?, ?, CURRENT_DATE + INTERVAL '5 days',?) RETURNING ordr_id";
	...
	public void insertIntoOrders(orderModel or, List<ProductStockPrice> al) {
		...
		jdbcTemplate.update(con -> {
			...
			ps.setInt(10, Integer.parseInt(or.getShippingPincode()));
			return ps;
		}, keyHolder);
